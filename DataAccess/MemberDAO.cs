...
namespace DataAccess
{
    public class MemberDAO
    {
        ...
        public MemberObject GetMemberByEmail(string email)
        {
            ...
            {
                member = new MemberObject(Convert.ToInt32(dbDataReader["MemberId"]), dbDataReader["Email"].ToString(),
        ...
        public void UpdateMember(MemberObject member)
        {
            ...
            sqlCommand.CommandText = "Update Member " +
                "SET Email =  @email, CompanyName = @company, City = @city, Country = @country, [Password] = @password " +
